<?php
// Memasukkan header dan konfigurasi
...
// Query untuk mendapatkan nama lengkap pengguna
...
// Memeriksa apakah data nama lengkap ditemukan
...
// Query untuk menghitung jumlah pesanan (poin)
...
// Query untuk menghitung total poin yang sudah ditukar
...
// Query untuk menghitung total poin yang telah digunakan
    ...
    <body class="bg-gray-50">
        <div class="container">
            <div class="row justify-content-center">
                    ...
                    <div class="card shadow-lg border-0 rounded-lg overflow-hidden">
                        ...
                        <div class="card-body text-center">
                            ...
                            <div class="d-flex justify-content-center gap-3 mt-3">
                                <button type="button" class="btn bg-pink-500 hover:bg-pink-700 text-white font-medium py-3 px-5 w-full rounded-lg shadow-md transition duration-300" onclick="window.location.href='riwayat_tukarpoin.php';">
                ...
                <div class="col-md-5 col-6 mb-4">
                    <div class="card shadow-lg border-0 rounded-lg overflow-hidden">
                        ...
                        <div class="card-body text-center">
                            ...
                            <div class="d-flex justify-content-center gap-3 mt-3">
                                <button type="button" class="btn bg-pink-500 hover:bg-pink-700 text-white font-medium py-3 px-5 w-full rounded-lg shadow-md transition duration-300" onclick="window.location.href='riwayat_tukarpakaian.php';">
                ...
                <!-- Syarat dan Ketentuan di dalam Card -->
                <div class="col-md-10 col-6 mb-4">
                    <div class="card shadow-lg border-0 rounded-lg overflow-hidden">
                        <div class="card-body">
